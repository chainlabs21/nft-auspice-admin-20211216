                ...
                <Col>
                  <Form.Group>
                    <Form.Check
                      custom
                      required
                      isInvalid={!data.supportedCheckbox}
                      isValid={data.supportedCheckbox}
                      type="checkbox"
                      id="supported-checkbox"
                      label="Check this custom checkbox"
                      feedback={
                        data.supportedCheckbox
                          ? false
                  ...
                  <Form.Group>
                    <Form.Check
                      custom
                      required
                      isInvalid={!data.supportedRadio}
                      isValid={data.supportedRadio}
                      type="radio"
                      label="Toggle this custom radio"
                      name="supportedRadio"
                      id="supportedRadio1"
                      onChange={() =>
                        setData({ ...data, supportedRadio: true })
                      }
                    />
                    <Form.Check
                      custom
                  ...
                  <Form.Group className="mt-3">
                    <Form.Control
                      as="select"
                      required
                      value={data.supportedSelect}
                      isInvalid={data.supportedSelect === 0}
                      isValid={data.supportedSelect !== 0}
                      onChange={supportedSelectHandler}
                    >
                  ...
                  <div className="custom-file">
                    <Form.Control
                      ...
                      required
                      isInvalid={!data.supportedFile}
                      isValid={data.supportedFile}
                      onChange={supportedFileHandler}
                    />
                    <Form.Label
