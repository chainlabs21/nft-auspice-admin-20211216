        ...
        <Col>
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>variant="dark"</code> with <code>Table</code>{" "}
                component
              </span>
            </Card.Header>
            <Card.Body>
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>className="table-*"</code> with <code>tr</code>{" "}
                element
              </span>
            </Card.Header>
            <Card.Body>
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>className="bg-* text-*"</code> with{" "}
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>size="sm"</code> with <code>Table</code>{" "}
                component
              </span>
            </Card.Header>
            <Card.Body>
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>className="table-columned"</code> with{" "}
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>className="table-*"</code> with{" "}
          ...
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">
                use props <code>variant="info"</code> with <code>Table</code>{" "}
                component
              </span>
            </Card.Header>
            <Card.Body>
