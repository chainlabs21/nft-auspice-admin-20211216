        ...
        <Col sm={12}>
          <Card>
            ...
            <Card.Body>
              ...
              <Button
                variant="primary"
                onClick={() => setData({ ...data, isBasic: true })}
              >
                Launch demo modal
              </Button>
              <Modal
                show={data.isBasic}
                onHide={() => setData({ ...data, isBasic: false })}
              >
                <Modal.Header closeButton>
                  <Modal.Title as="h5">Modal Title</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => setData({ ...data, isBasic: false })}
                  >
                    Close
                  </Button>
                  <Button variant="primary">Save Changes</Button>
            ...
            <Card.Body>
              ...
              >
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => setData({ ...data, isVertically: false })}
                  >
                    Close
                  </Button>
                  <Button variant="primary">Save Changes</Button>
        ...
        <Col md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Button
                variant="primary"
                onClick={() => setData({ ...data, isTooltip: true })}
              >
                Launch demo modal
              </Button>
              <Modal
                show={data.isTooltip}
                onHide={() => setData({ ...data, isTooltip: false })}
              >
                <Modal.Header closeButton>
                  <Modal.Title as="h5">Modal Title</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  ...
                  <p>
                    ...
                    <OverlayTrigger
                      overlay={() => (
                        <Tooltip id="modal1">Tooltip Bottom</Tooltip>
                      )}
                    >
                  ...
                  <p>
                    This
                    <OverlayTrigger
                      overlay={() => <Tooltip id="modal2">Tooltip Lnk</Tooltip>}
                    >
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => setData({ ...data, isTooltip: false })}
                  >
                    Close
                  </Button>
                  <Button variant="primary">Save Changes</Button>
        ...
        <Col md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Button
                variant="primary"
                onClick={() => setData({ ...data, isGrid: true })}
              >
                Launch demo modal
              </Button>
              <Modal
                show={data.isGrid}
                onHide={() => setData({ ...data, isGrid: false })}
              >
                <Modal.Header closeButton>
                  ...
                  <div className="bd-example-row">
                    <Container fluid>
                      ...
                      <Row>
                        ...
                        <Col
                          md={{ span: 2, offset: 4 }}
                        >{`md={{ span: 2, offset: 4 }}`}</Col>
                      </Row>
                      <Row>
                        <Col
                          md={{ span: 6, offset: 6 }}
                        >{`md={{ span: 6, offset: 6 }}`}</Col>
                      </Row>
                      <Row>
                        <Col sm={9}>
                          Level 1: sm=9
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => setData({ ...data, isGrid: false })}
                  >
                    Close
                  </Button>
                  <Button variant="primary">Save Changes</Button>
        ...
        <Col md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Button
                variant="primary"
                onClick={() => setData({ ...data, isScrolling: true })}
              >
                Launch demo modal
              </Button>
              <Modal
                show={data.isScrolling}
                onHide={() => setData({ ...data, isScrolling: false })}
              >
                <Modal.Header closeButton>
                  <Modal.Title as="h5">Modal Title</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => setData({ ...data, isScrolling: false })}
                  >
                    Close
                  </Button>
                  <Button variant="primary">Save Changes</Button>
        ...
        <Col md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Button
                variant="primary"
                onClick={() => setData({ ...data, isLarge: true })}
              >
                Large modal
              </Button>
              <Modal
                size="lg"
                show={data.isLarge}
                onHide={() => setData({ ...data, isLarge: false })}
              >
                <Modal.Header closeButton>
        ...
        <Col md={6} xl={4}>
          <Card>
            ...
            <Card.Body>
              <Button
                variant="primary"
                onClick={() => setData({ ...data, isSmall: true })}
              >
                Small modal
              </Button>
              <Modal
                size="sm"
                show={data.isSmall}
                onHide={() => setData({ ...data, isSmall: false })}
              >
                <Modal.Header closeButton>
          ...
          <Card>
            ...
            <Card.Body className="btn-page">
              <Button
                variant="primary"
                onClick={() =>
                  setData({ ...data, isVarying: true, title: "@mdo" })
                }
              >
                Open modal for @mdo
              </Button>
              <Button
                variant="primary"
                onClick={() =>
                  setData({ ...data, isVarying: true, title: "@fat" })
                }
              >
                Open modal for @fat
              </Button>
              <Button
                variant="primary"
                onClick={() =>
                  setData({ ...data, isVarying: true, title: "@bootstrap" })
                }
              >
              ...
              <Modal
                show={data.isVarying}
                onHide={() => setData({ ...data, isVarying: false })}
              >
                <Modal.Header closeButton>
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={() => setData({ ...data, isVarying: false })}
                  >
                    Close
                  </Button>
                  <Button variant="primary">Save Changes</Button>
