      ...
      <div className="form-group mb-0">
        <div className="switch switch-primary d-inline m-r-10">
          <input
            ...
            onChange={onChangeHeaderFixedLayout}
          />
