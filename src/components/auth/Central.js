...
import { setEnrollCentralPopup } from "../../util/store";
import PopupBg from "../PopupBg";
import EnrollCentralPopup from "./EnrollCentralPopup";

function Transfers({ store, setEnrollCentralPopup }) {
  const navigate = useNavigate();

  return (
    <TransfersBox>
      <div className="topBar">
        <img src={I_plus} alt="" onClick={setEnrollCentralPopup} />
      </div>
...
function mapDispatchToProps(dispatch) {
  return {
    setEnrollCentralPopup: () => dispatch(setEnrollCentralPopup()),
  };
}
