...
function EnrollCryptoPopup({ store }) {
  const enrollRef = useRef();
  const [address, setAddress] = useState("");

  return (
    <EnrollCryptoPopupBox>
        ...
        <ul className="infoList">
          <li>
            ...
            <span className="value">
              ...
              <p className="alarm">*유효한 주소가 아닙니다</p>
            </span>
          </li>
        </ul>
...
const EnrollCryptoPopupBox = styled.div`
  width: 460px;
  background: #fff;
  border-radius: 20px;
...
export default connect(mapStateToProps, mapDispatchToProps)(EnrollCryptoPopup);
