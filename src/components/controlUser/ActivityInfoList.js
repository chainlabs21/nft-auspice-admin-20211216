...
function ActivityInfoList({ store }) {
  return (
    <ActivityInfoListBox>
      <div className="topBar">
        <div className="titleBox">
          <strong className="subtitle">사용자 활동 상세조회</strong>
        </div>
      </div>

      <ul className="infoList">
        <li>
          <span className="key">유저 아이디</span>
...
const ActivityInfoListBox = styled.div`
  display: flex;
...
export default connect(mapStateToProps, mapDispatchToProps)(ActivityInfoList);
